<aside class="app-sidebar">
    ...
    <div class="app-sidebar__user">
        <div class="dropdown user-pro-body text-center">
            <div class="user-pic">
                <img loading="lazy" src="<?php echo base_url('assets/admin/images/users/2.jpg'); ?>" alt="user-img" class="avatar-xl rounded-circle mb-1">
            </div>
            <div class="user-info">
        ...
        <div class="sidebar-navs">
            <ul class="nav nav-pills-circle">
                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Support">
                    <a class="icon" href="#"><i class="las la-life-ring header-icons"></i></a>
                </li>
                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Documentation">
                    <a class="icon" href="#"><i class="las la-file-alt header-icons"></i></a>
                </li>
                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Projects">
                    <a href="#" class="icon"><i class="las la-project-diagram header-icons"></i></a>
                </li>
                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Settings">
                    <a class="icon" href="#"><i class="las la-cog header-icons"></i></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                <i class="las la-image side-menu__icon"></i>
                <span class="side-menu__label">Gallery</span>
                <i class="angle fa fa-angle-right"></i>
            </a>
            <ul class="slide-menu">
                <li><a class="sub-slide-item" href="<?php echo base_url('Admin/imagegallery') ?>">Image Gallery</a></li>
                <li><a class="sub-slide-item" href="<?php echo base_url('Admin/videogallery') ?>">Video Gallery</a></li>
            </ul>
        </li>

        <!-- Leads Menu (New) -->
        <li class="slide">
            <a class="side-menu__item" href="<?php echo base_url('Admin/lead'); ?>">
